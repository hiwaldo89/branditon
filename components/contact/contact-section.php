<div class="container py-20 mx-auto text-center contact-section">
    ...
    <a href="mailto:fernanda@branditon.com.mx" class="inline-block text-xl mb-16 contact-section__email font-secondary tracking-widest">fernanda@branditon.com.mx</a>
    ...
    <p class="text-2xl font-secondary--italic tracking-widest">
