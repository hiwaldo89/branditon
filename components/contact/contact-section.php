<div class="container py-12 mx-auto text-center contact-section">
    ...
    <p class="text-3xl">Envíame un correo a:</p>
    <a href="mailto:fernanda@branditon.com.mx" class="inline-block text-3xl" class="contact-section__email">fernanda@branditon.com.mx</a>
    <div class="flex items-center justify-center contact-section__social">
